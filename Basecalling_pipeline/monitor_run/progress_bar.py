...
# Code from https://github.com/slok/pygressbar. Thank you
...
class CustomPercentProgressBar(PygressBar):
    def __init__(self,
                length,
                filled_repr,
                empty_repr,
                ...
                scale_start,
                scale_end):
        super(CustomPercentProgressBar, self).__init__(length=length,
                                                filled_repr=filled_repr,
                                                empty_repr=empty_repr,
                                                left_limit=left_limit,
                                                right_limit=right_limit,
