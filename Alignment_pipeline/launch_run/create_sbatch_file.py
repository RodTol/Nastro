...
def create_sbatch_file(path_to_config, path_to_sbatch):
    ...
    with open(path_to_sbatch, "w") as sbatch_file:
        ...
        #sbatch_file.write("python3 ${HOME}/Nastro/GPU_log/resource_profiling.py $SLURM_MEM_PER_NODE $SLURM_CPUS_PER_TASK /orfeo/cephfs/home/area/jenkins_onpexp/Nastro.csv AL &\n")
